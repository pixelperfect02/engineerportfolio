...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-orange-100">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              {/* <p className="leading-relaxed">Available on Request</p> */}
              <a
              href="#contact"
        ...
        <form
          ...
          <h2 className="sm:text-4xl text-3xl font-medium title-font mb-4 text-black text-center">
                      Hire Me
          </h2>
  ...
  <br></br>
          ...
          <button
            type="submit"
            className="text-white navbar-brand bg-pink-700 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
            Submit
          </button>
        </form>
      </div>
