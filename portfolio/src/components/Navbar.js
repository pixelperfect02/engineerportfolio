...
export default function Navbar() {
  return (
    <header className="bg-white text-[#706F6F] md:sticky top-0 z-10 shadow-lg">
      <div className="container mx-auto p-6 flex justify-between items-center">
        {/* Logo Section */}
        <a href="#about" className="text-4xl font-extrabold font-serif text-[#706F6F]">
          <img
            className="object-contain h-40 w-56 rounded" // Increased size here
            alt="hero"
            src="./sign.png"
          />
        </a>
